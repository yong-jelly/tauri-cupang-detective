      ...
      <div className="p-5">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#f6f1e9] border-2 border-gray-800 flex items-center justify-center">
              <span className="text-xl" role="img" aria-label={account.provider}>
                {getProviderIcon(account.provider)}
              </span>
            </div>
            <div>
              <h3 className="font-bold text-gray-900 font-serif text-lg">{account.alias}</h3>
